...
const Project = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-40">
      ...
      {/* Subheading */}
      <h4 className="font-[second] text-black text-sm mt-5 text-extrabold">
        my awesome work
      </h4>
      <p className="text-sm font-[second] text-gray-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-10 p-24">
        {Data.map((item) => (
          <div
            key={item.id}
            className="bg-[#FEFAE0] rounded-md overflow-hidden"
          >
            {/* Project Image */}
            <img
              src={item.image}
            ...
            <div className="p-5 font-[first]">
              <h1 className="text-xl font-[first] font-semibold text-black">{item.name}</h1>
              <h2 className="text-sm font-[first] text-gray-700 mt-2">{item.description}</h2>
