...
const Home = () => {
    ...
    return (
        <div className="w-full relative h-[100vh] flex flex-col items-center justify-center px-4 sm:px-8 md:px-16 lg:px-32">
            ...
            {/* Scroll Indicator */}
            <div className="absolute bottom-14 right-14 rotate-90 tracking-[10px] font-[first] flex flex-col uppercase text-gray-600 text-sm sm:text-base md:text-lg">
                <h4>scroll</h4>
                <span className="w-full bg-black h-[1px] animate-lineMove"></span>
            </div>

            {/* Subtitle */}
            <div className="mt-4 w-[60%] sm:w-[50%] md:w-[40%] lg:w-[30%]">
                <p className="text-gray-700 text-sm tracking-[5px] uppercase lg:text-base text-center">
                    {currentText}
                </p>
                <div className="w-full bg-black animate-textLine relative bottom-6 h-full"></div>
            </div>
        </div>
    );
};
