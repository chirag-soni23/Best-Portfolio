  ...
  return (
    <div className="w-full h-full mt-20 flex flex-col items-center justify-center px-4 sm:px-8 md:px-16 lg:px-32">
      <div className="relative text-center">
        ...
        >
          <h4 className="uppercase text-pretty text-6xl sm:text-7xl md:text-8xl lg:text-8xl mt-2 font-[first]">
            what i do
          </h4>
        </h4>
        {/* Shadow Effect */}
      ...
      <div className="relative text-center mt-5">
        ...
        >
          <h4 className="text-pretty sm:text-7xl md:text-8xl lg:text-2xl mt-2 font-[first]">
            Web Design
          </h4>
        </h4>
        {/* Shadow Effect */}
      ...
      <p
        className={`font-[second] text-sm sm:text-base md:text-lg lg:text-xl text-center ${
          darkMode ? "text-[#F1F3DF]" : "text-gray-700"
        } mt-10 max-w-[80%] sm:max-w-[70%] md:max-w-[60%] lg:max-w-[100%] tracking-widest`}
      >
        I design beautiful and powerful websites for modern businesses. Any
        business today needs a website that wins customers’ trust and helps you
        do your business well. I make sure your website is up to that standard.
      </p>
      ...
      >
        I am a skilled Full Stack Developer with expertise in both frontend and
        backend technologies. Proficient in the MERN stack (MongoDB, Express,
        React, Node.js), I specialize in building scalable, responsive web
        applications. I have experience with RESTful APIs, user authentication,
        and third-party integrations. Passionate about creating efficient and
      ...
      <div className="mt-20 flex gap-3 items-center justify-center w-1/2">
        ...
        <a
          href={resume}
          download="Resume.pdf"
          className={`flex relative h-[34px] min-w-[118px] flex-1 items-center cursor-pointer justify-center rounded-sm border ${
            darkMode ? "border-[#F1F3DF]" : "border-black"
          } px-5 text-small lg:flex-none`}
        >
          Resume
